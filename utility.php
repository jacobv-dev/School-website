...
<body>
    ...
    <section class="utility">
        ...
        <fieldset class="jidelnicek">
            ...
            <?php include './Components/Jidelnicek.php'; ?>
        ...
        <fieldset>
            ...
            shuffle($a);
            foreach ($a as $x) {
                echo "<img style=\"height: 80px; width: 80px; margin: 25px\" alt=\"Hrací kostka\"  src=\"img/kostky/" . $x . ".png\" >";
            }
            ?>
        </fieldset>
